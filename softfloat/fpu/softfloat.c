...
| desired.)
*----------------------------------------------------------------------------*/
#include "../include/softfloat-macros.h"
 ...
 * expensive exception flag register aaccelsses.
 *
...
static const FloatFmt float4_params = {
    FLOAT_PARAMS(2, 1)
};

static const FloatFmt float4_1_params = {
    FLOAT_PARAMS(1, 2)
};
...
static inline void float4_unpack_raw(FloatParts64 *p, float4 f)
{
    unpack_raw64(p, &float4_params, f);
}

static inline void float4_1_unpack_raw(FloatParts64 *p, float4 f)
{
    unpack_raw64(p, &float4_1_params, f);
}
...
static inline float4 float4_pack_raw(const FloatParts64 *p)
{
    return make_float4(pack_raw64(p, &float4_params));
}

static inline float4_1 float4_1_pack_raw(const FloatParts64 *p)
{
    return make_float4_1(pack_raw64(p, &float4_1_params));
}
...
static void float4_unpack_canonical(FloatParts64 *p, float4 f,
                                      float_status *s)
{
    float4_unpack_raw(p, f);
    parts_canonicalize(p, s, &float4_params);
}

static void float4_1_unpack_canonical(FloatParts64 *p, float4_1 f,
                                      float_status *s)
{
    float4_1_unpack_raw(p, f);
    parts_canonicalize(p, s, &float4_1_params);
}
...
static float4 float4_round_pack_canonical(FloatParts64 *p,
                                              float_status *s)
{
    parts_uncanon(p, s, &float4_params);
    return float4_pack_raw(p);
}

static float4_1 float4_1_round_pack_canonical(FloatParts64 *p,
                                              float_status *s)
{
    parts_uncanon(p, s, &float4_1_params);
    return float4_1_pack_raw(p);
}
...
static float4 QEMU_FLATTEN
float4_addsub(float4 a, float4 b, float_status *status, bool subtract)
{
    FloatParts64 pa, pb, *pr;

    float4_unpack_canonical(&pa, a, status);
    float4_unpack_canonical(&pb, b, status);
    pr = parts_addsub(&pa, &pb, status, subtract);

    return float4_round_pack_canonical(pr, status);
}

static float4_1 QEMU_FLATTEN
float4_1_addsub(float4_1 a, float4_1 b, float_status *status, bool subtract)
{
    FloatParts64 pa, pb, *pr;

    float4_1_unpack_canonical(&pa, a, status);
    float4_1_unpack_canonical(&pb, b, status);
    pr = parts_addsub(&pa, &pb, status, subtract);

    return float4_1_round_pack_canonical(pr, status);
}
...
float4 float4_add(float4 a, float4 b, float_status *status)
{
    return float4_addsub(a, b, status, false);
}

float4_1 float4_1_add(float4_1 a, float4_1 b, float_status *status)
{
    return float4_1_addsub(a, b, status, false);
}

float4 float4_sub(float4 a, float4 b, float_status *status)
{
    return float4_addsub(a, b, status, true);
}

float4_1 float4_1_sub(float4_1 a, float4_1 b, float_status *status)
{
    return float4_1_addsub(a, b, status, true);
}
...
float4 QEMU_FLATTEN float4_mul(float4 a, float4 b, float_status *status)
{
    FloatParts64 pa, pb, *pr;
...
float4_1 QEMU_FLATTEN float4_1_mul(float4_1 a, float4_1 b, float_status *status)
{
    FloatParts64 pa, pb, *pr;
...
float4 QEMU_FLATTEN float4_muladd(float4 a, float4 b, float4 c,
                                    int flags, float_status *status)
{
    ...
    float4_unpack_canonical(&pa, a, status);
    float4_unpack_canonical(&pb, b, status);
    float4_unpack_canonical(&pc, c, status);
    pr = parts_muladd(&pa, &pb, &pc, flags, status);

    return float4_round_pack_canonical(pr, status);
}

float4_1 QEMU_FLATTEN float4_1_muladd(float4_1 a, float4_1 b, float4_1 c,
                                    int flags, float_status *status)
{
    FloatParts64 pa, pb, pc, *pr;
    ...
    float4_1_unpack_canonical(&pa, a, status);
    float4_1_unpack_canonical(&pb, b, status);
    float4_1_unpack_canonical(&pc, c, status);
    pr = parts_muladd(&pa, &pb, &pc, flags, status);
...
float4 float4_div(float4 a, float4 b, float_status *status)
{
    FloatParts64 pa, pb, *pr;
...
float4_1 float4_1_div(float4_1 a, float4_1 b, float_status *status)
{
    FloatParts64 pa, pb, *pr;
...
float4_1 float4_to_float4_1(float4 a, float_status *s)
{
    FloatParts64 p;

    float4_unpack_canonical(&p, a, s);
    parts_float_to_float(&p, s);
    return float4_1_round_pack_canonical(&p, s);
}

float8 float4_to_float8(float4 a, float_status *s)
{
    FloatParts64 p;
...
float8_1 float4_to_float8_1(float4 a, float_status *s)
{
    FloatParts64 p;
...
float16 float4_to_float16(float4 a, float_status *s)
{
    FloatParts64 p;
...
float32 float4_to_float32(float4 a, float_status *s)
{
    FloatParts64 p;
...
float64 float4_to_float64(float4 a, float_status *s)
{
    FloatParts64 p;
...
bfloat16 float4_to_bfloat16(float4 a, float_status *s)
{
    FloatParts64 p;
...
float4 float4_1_to_float4(float4_1 a, float_status *s)
{
    FloatParts64 p;

    float4_1_unpack_canonical(&p, a, s);
    parts_float_to_float(&p, s);
    return float4_round_pack_canonical(&p, s);
}

float8 float4_1_to_float8(float4_1 a, float_status *s)
{
    FloatParts64 p;
...
float8_1 float4_1_to_float8_1(float4_1 a, float_status *s)
{
    FloatParts64 p;
...
float16 float4_1_to_float16(float4_1 a, float_status *s)
{
    FloatParts64 p;
...
float32 float4_1_to_float32(float4_1 a, float_status *s)
{
    FloatParts64 p;
...
float64 float4_1_to_float64(float4_1 a, float_status *s)
{
    FloatParts64 p;
...
bfloat16 float4_1_to_bfloat16(float4_1 a, float_status *s)
{
    FloatParts64 p;
...
float4 float8_to_float4(float8 a, float_status *s)
{
    FloatParts64 p;
...
float4_1 float8_to_float4_1(float8 a, float_status *s)
{
    FloatParts64 p;
...
float4 float8_1_to_float4(float8_1 a, float_status *s)
{
    FloatParts64 p;
...
float4_1 float8_1_to_float4_1(float8_1 a, float_status *s)
{
    FloatParts64 p;
...
float4 float16_to_float4(float16 a, float_status *s)
{
    FloatParts64 p;
...
float4_1 float16_to_float4_1(float16 a, float_status *s)
{
    FloatParts64 p;
...
float4 float32_to_float4(float32 a, float_status *s)
{
    FloatParts64 p;
...
float4_1 float32_to_float4_1(float32 a, float_status *s)
{
    FloatParts64 p;
...
float4 float64_to_float4(float64 a, float_status *s)
{
    FloatParts64 p;
...
float4_1 float64_to_float4_1(float64 a, float_status *s)
{
    FloatParts64 p;
...
float4 bfloat16_to_float4(bfloat16 a, float_status *s)
{
    FloatParts64 p;
...
float4_1 bfloat16_to_float4_1(bfloat16 a, float_status *s)
{
    FloatParts64 p;
...
#define BF16_MAN_BITS      7

#define E6M2_EXP_BITS      6
#define E6M2_MAN_BITS      2
#define E6M2_EXP_BIAS      48

#define E6M2_UNBIASED_EXP_MIN   (-48)
#define E6M2_UNBIASED_EXP_MAX   (15)

#define E6M2_NAN          0xFFu
#define E6M2_MAX_VALUE    0xFEu
#define E6M2_MIN_VALUE    0x00u

static uint8_t e6m2_pack(uint32_t exp, uint32_t mant)
{
    return (uint8_t)(((exp & 0x3Fu) << E6M2_MAN_BITS) |
                     ((mant & 0x03u)));
}

static int floor_log2_u32(uint32_t x)
{
    int r = -1;
...
static uint64_t rshift_round_u64(uint64_t x,
                                 unsigned shift,
                                 FloatRoundMode rm)
{
    if (shift == 0) {
    ...
    uint64_t q = x >> shift;
    uint64_t rem_mask = (1ULL << shift) - 1ULL;
    uint64_t rem = x & rem_mask;
...
static uint64_t round_sig_pow2(uint32_t sig,
                               int k,
                               FloatRoundMode rm)
{
    if (k >= 0) {
        ...
        return ((uint64_t)sig) << k;
    } else {
        return rshift_round_u64((uint64_t)sig, (unsigned)(-k), rm);
    }
}

uint8_t bfloat16_to_e6m2(bfloat16 f, float_status *status)
{
    ...
    uint32_t bman = bf16 & 0x7Fu;

    if (bexp == 0xFFu) {
        if (bman != 0) {
            return E6M2_NAN;
        }
        return sign ? E6M2_MIN_VALUE : E6M2_MAX_VALUE;
    }

    if (sign) {
        return E6M2_MIN_VALUE;
    }
    ...
    if (bexp == 0) {
        ...
        sig = (1u << BF16_MAN_BITS) | bman;
        E = (int)bexp - BF16_EXP_BIAS - BF16_MAN_BITS;
    }

    int log2sig = floor_log2_u32(sig);
    int unbiased_exp = log2sig + E;
    if (unbiased_exp < E6M2_UNBIASED_EXP_MIN) {
        return E6M2_MIN_VALUE;
    }
    if (unbiased_exp > E6M2_UNBIASED_EXP_MAX) {
        return E6M2_MAX_VALUE;
    }
    int k = E - (unbiased_exp - E6M2_MAN_BITS);
    uint64_t M = round_sig_pow2(sig, k, rm);
    if (M >= (1u << (E6M2_MAN_BITS + 1))) {
        M >>= 1;
        unbiased_exp++;
    }
    if (unbiased_exp > E6M2_UNBIASED_EXP_MAX) {
    ...
    uint32_t e6m2_exp = (uint32_t)(unbiased_exp + E6M2_EXP_BIAS);
    uint32_t e6m2_man = (uint32_t)(M - (1u << E6M2_MAN_BITS));
    if (e6m2_exp > 63u) {
        return E6M2_MAX_VALUE;
    }
    if (e6m2_man > 3u) {
    ...
    uint8_t out = e6m2_pack(e6m2_exp, e6m2_man);
    if (out == E6M2_NAN) {
        return E6M2_MAX_VALUE;
    }
    if (out > E6M2_MAX_VALUE) {
        return E6M2_MAX_VALUE;
    }
    return out;
}
...
/*----------------------------------------------------------------------------
| Software float4 conversion routines.
*----------------------------------------------------------------------------*/

int8_t float4_to_int8_scalbn(float4 a, FloatRoundMode rmode, int scale,
                              float_status *s)
{
    FloatParts64 p;
...
int16_t float4_to_int16_scalbn(float4 a, FloatRoundMode rmode, int scale,
                                float_status *s)
{
    FloatParts64 p;
...
int32_t float4_to_int32_scalbn(float4 a, FloatRoundMode rmode, int scale,
                                float_status *s)
{
    FloatParts64 p;
...
int64_t float4_to_int64_scalbn(float4 a, FloatRoundMode rmode, int scale,
                                float_status *s)
{
    FloatParts64 p;
...
uint8_t float4_to_uint8_scalbn(float4 a, FloatRoundMode rmode, int scale,
                                float_status *s)
{
    FloatParts64 p;
...
uint16_t float4_to_uint16_scalbn(float4 a, FloatRoundMode rmode, int scale,
                                  float_status *s)
{
    FloatParts64 p;
...
uint32_t float4_to_uint32_scalbn(float4 a, FloatRoundMode rmode, int scale,
                                  float_status *s)
{
    FloatParts64 p;
...
uint64_t float4_to_uint64_scalbn(float4 a, FloatRoundMode rmode, int scale,
                                  float_status *s)
{
    FloatParts64 p;
...
/*----------------------------------------------------------------------------
| Software float4_1 conversion routines.
*----------------------------------------------------------------------------*/

int8_t float4_1_to_int8_scalbn(float4_1 a, FloatRoundMode rmode, int scale,
                              float_status *s)
{
    FloatParts64 p;
...
int16_t float4_1_to_int16_scalbn(float4_1 a, FloatRoundMode rmode, int scale,
                                float_status *s)
{
    FloatParts64 p;
...
int32_t float4_1_to_int32_scalbn(float4_1 a, FloatRoundMode rmode, int scale,
                                float_status *s)
{
    FloatParts64 p;
...
int64_t float4_1_to_int64_scalbn(float4_1 a, FloatRoundMode rmode, int scale,
                                float_status *s)
{
    FloatParts64 p;
...
uint8_t float4_1_to_uint8_scalbn(float4_1 a, FloatRoundMode rmode, int scale,
                                float_status *s)
{
    FloatParts64 p;
...
uint16_t float4_1_to_uint16_scalbn(float4_1 a, FloatRoundMode rmode, int scale,
                                  float_status *s)
{
    FloatParts64 p;
...
uint32_t float4_1_to_uint32_scalbn(float4_1 a, FloatRoundMode rmode, int scale,
                                  float_status *s)
{
    FloatParts64 p;
...
uint64_t float4_1_to_uint64_scalbn(float4_1 a, FloatRoundMode rmode, int scale,
                                  float_status *s)
{
    FloatParts64 p;
...
/*----------------------------------------------------------------------------
| Software float8 conversion routines.
*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
| Software float8_1 conversion routines.
*----------------------------------------------------------------------------*/
...
float4 uint64_to_float4_scalbn(uint64_t a, int scale, float_status *status)
{
    FloatParts64 p;

    parts_uint_to_float(&p, a, scale, status);
    return float4_round_pack_canonical(&p, status);
}

float4 int64_to_float4_scalbn(int64_t a, int scale, float_status *status)
{
    FloatParts64 p;
...
float4_1 uint64_to_float4_1_scalbn(uint64_t a, int scale, float_status *status)
{
    FloatParts64 p;

    parts_uint_to_float(&p, a, scale, status);
    return float4_1_round_pack_canonical(&p, status);
}

float4_1 int64_to_float4_1_scalbn(int64_t a, int scale, float_status *status)
{
    FloatParts64 p;
...
static float4 float4_minmax(float4 a, float4 b, float_status *s, int flags)
{
    FloatParts64 pa, pb, *pr;

    float4_unpack_canonical(&pa, a, s);
    float4_unpack_canonical(&pb, b, s);
    pr = parts_minmax(&pa, &pb, s, flags);

    return float4_round_pack_canonical(pr, s);
}

static float4_1 float4_1_minmax(float4_1 a, float4_1 b, float_status *s, int flags)
{
    FloatParts64 pa, pb, *pr;

    float4_1_unpack_canonical(&pa, a, s);
    float4_1_unpack_canonical(&pb, b, s);
    pr = parts_minmax(&pa, &pb, s, flags);

    return float4_1_round_pack_canonical(pr, s);
}
...
float4_do_compare(float4 a, float4 b, float_status *s, bool is_quiet)
{
    FloatParts64 pa, pb;
...
FloatRelation float4_compare(float4 a, float4 b, float_status *s)
{
    return float4_do_compare(a, b, s, false);
}

FloatRelation float4_compare_quiet(float4 a, float4 b, float_status *s)
{
    return float4_do_compare(a, b, s, true);
}

static FloatRelation QEMU_FLATTEN
float4_1_do_compare(float4_1 a, float4_1 b, float_status *s, bool is_quiet)
{
    FloatParts64 pa, pb;
...
FloatRelation float4_1_compare(float4_1 a, float4_1 b, float_status *s)
{
    return float4_1_do_compare(a, b, s, false);
}

FloatRelation float4_1_compare_quiet(float4_1 a, float4_1 b, float_status *s)
{
    return float4_1_do_compare(a, b, s, true);
}
...
float4 float4_scalbn(float4 a, int n, float_status *status)
{
    FloatParts64 p;

    float4_unpack_canonical(&p, a, status);
    parts_scalbn(&p, n, status);
    return float4_round_pack_canonical(&p, status);
}

float4_1 float4_1_scalbn(float4_1 a, int n, float_status *status)
{
    FloatParts64 p;

    float4_1_unpack_canonical(&p, a, status);
    parts_scalbn(&p, n, status);
    return float4_1_round_pack_canonical(&p, status);
}
...
float4 QEMU_FLATTEN float4_sqrt(float4 a, float_status *status)
{
    FloatParts64 p;

    float4_unpack_canonical(&p, a, status);
    parts_sqrt(&p, status, &float4_params);
    return float4_round_pack_canonical(&p, status);
}

float8_1 QEMU_FLATTEN float4_1_sqrt(float4_1 a, float_status *status)
{
    FloatParts64 p;

    float4_1_unpack_canonical(&p, a, status);
    parts_sqrt(&p, status, &float4_1_params);
    return float4_1_round_pack_canonical(&p, status);
}
 ...
 * log2
 */
float32 float32_log(float32 a, float_status *status)
{
    FloatParts64 p;
...
float64 float64_log(float64 a, float_status *status)
{
    FloatParts64 p;
...
float32 float32_exp(float32 a, float_status *status)
{
